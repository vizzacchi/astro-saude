...
<head>
    ...
    <title>Astro Vida e Saúde | Ameplan Saúde</title>
    ...
    <meta name="description"  	content="A Ameplan está presente em toda capital Paulista com mais de 500 prestadores entre hospitais, pronto-socorro, maternidades, clínicas ambulatoriais e centro de diagnósticos." />
    <meta name="keywords" 		content="Ameplan, Ameplan Saúde, Planos de Saúde Ameplan, Convênio Ameplan, Convênio Médico Ameplan" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Ameplan Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="A Ameplan está presente em toda capital Paulista com mais de 500 prestadores entre hospitais, pronto-socorro, maternidades, clínicas ambulatoriais e centro de diagnósticos.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ameplan</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Ameplan Saúde<br>
                <span class="h2">O plano de saúde que você busca na cidade de São Paulo.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/ameplan-saude.webp" alt="Logo Ameplan Saúde" title="Logo Ameplan Saúde">
            </div>
            <div class="col-12 col-md-6">
                <p>A <strong>Ameplan</strong> é uma Operadora de Planos de Saúde que atua no mercado há 30 anos. Atualmente a <strong>Ameplan</strong> é uma das operadoras de plano de saúde que mais investe em atendimento de excelência e inovação, no estado de São Paulo. Iniciou suas atividades com apenas uma pequena policlínica na zona sul de São Paulo, mas hoje está presente por toda capital paulista e grande São Paulo, com mais de 500 prestadores entre hospitais, pronto-socorro, maternidade, clínicas ambulatoriais e centros de diagnósticos. Os planos oferecidos pela <strong>Ameplan</strong> são diferenciados para atender o maior número possível de pessoas, sem prejudicar a qualidade e a segurança ao tratamento de todos os pacientes. Um facilitador da <strong>Ameplan</strong> é a marcação de consulta em sua rede credenciada através do seu Portal Digital. Toda essa dedicação da companhia tem um impacto direto no resultado de pesquisas de satisfação.</p>

            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Ameplan</h2>
                <ul class="mx-1">
                  <li>Portal Digital faz a marcação de consulta em tempo real.</li>
                  <li>Site atualizado que possibilita a ampliação dos atendimentos online da operadora, a marcação de exames e emissão de guias via internet, sem que o cliente precise se deslocar a uma central de atendimento.</li>
                  <li>Consultas em Telemedicina.</li>
                  <li>Descontos em farmácias parceiras.</li>
                  <li>Coleta de exames e atendimento emergencial a domicílio.</li>
                  <li>Planos sem taxa de coparticipação.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
