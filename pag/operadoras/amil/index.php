...
<head>
    ...
    <title>Astro Vida e Saúde | Amil Assistência Médica Internacional</title>
    ...
    <meta name="description"  	content="Com a Amil você têm acesso ao um portfólio de produtos completo, desenhado para atender bem não importa o seu perfil." />
    <meta name="keywords" 		content="Amil, Planos de Saúde Amil, Amil Assistência Médica, Convênios Amil, Amil Saúde" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Amil Assistência Médica">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Com a Amil você têm acesso ao um portfólio de produtos completo, desenhado para atender bem não importa o seu perfil.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
		  ...
		  <div class="clear">
            <h1 class="title">Amil Assistência Médica Internacional<br>
                <span class="h2">Plano para todos os perfis de beneficiários.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/amil.webp" alt="Logo Amil" title="Logo Amil">
            </div>
            <div class="col-12 col-md-6">
                <p>A Amil foi criada em 1978, no Rio de Janeiro e hoje é uma empresa de saúde que faz parte do UnitedHealth Group, a maior e mais diversificada empresa do setor de saúde do mundo, com sede nos Estados Unidos. A missão da Amil é ajudar as pessoas a viverem de forma mais saudável e contribuir para que o sistema de saúde funcione melhor para todos. A Amil possui programas de saúde com o objetivo de acompanhar mais de perto a sua saúde e propor um modelo integrado de atenção. Dentre os planos oferecidos estão:</p>
			<ul>
				<li>
					AMIL FACIL - Criado com os conceitos de simplicidade, eficiência e cuidado, a Amil Fácil oferece planos regionais com excelente custo-benefício.
				</li>
				<li>
					AMIL - Planos médicos com abrangência nacional ou regional, oferecendo a opção de coparticipação e de reembolso.</li>
				<li>
        ...
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Amil</h2>
                <ul class="mx-1">
                  <li>Amil Espaço Saúde são unidades ambulatoriais com atendimento multidisciplinar, exclusivas para clientes Amil, onde contam com estrutura para pronto atendimento, exames complementares e os diversos Programas Saúde Amil, inclusive transtornos do espectro autista.</li>
				          <li>Programas de Saúde Amil cujo objetivo é a prevenção de doenças e o acompanhamento daqueles que já possuem alguma enfermidade para reduzir os riscos à saúde e promover qualidade de vida. Esses atendimentos são fornecidos de forma presencial ou virtual</li>
				          <li>Alguns dos Programas de Saúde Amil: Controle do Tabagismos, Reabilitação Cardiopulmonar, Unidade Postural, Emagrecimento Clínico e Cirúrgico, Obesidade Infantil, Saúde Mental, entre outros.</li>
                  <li>Amil Resgate é um diferencial de alguns planos da Amil; trata-se da remoção de pacientes em estado grave e de alta complexidade em unidades equipadas com tecnologia de última geração em monitoramento, acompanhamento e tratamento.</li>
                  <li>Telemedicina sem necessidade de agendamento, 24 horas por dia, 7 dias na semana.</li>
                  <li>Planos com ou sem taxa de coparticipação.</li>
                  <li>Desconto em farmácias parceiras.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
