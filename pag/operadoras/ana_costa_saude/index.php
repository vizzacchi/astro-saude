...
<head>
    ...
    <title>Astro Vida e Saúde | Ana Costa Saúde</title>
    ...
    <meta name="description"  	content="Ana Costa Saúde, o plano de saúde do hospital Ana costaa melhor opção em planos de saúde na baixada santista." />
    <meta name="keywords" 		content="plano de saúde Ana costa, ana costa saúde, convênio médico ana costa, Ana Costa" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Ana Costa Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Ana Costa Saúde, o plano de saúde do hospital Ana costaa melhor opção em planos de saúde na baixada santista.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ana Costa Saúde</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Ana Costa Saúde<br>
                <span class="h2">A melhor escolha em plano de saúde na baixada santista.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/ana-costa-saude.webp" alt="Logo Ana Costa Saúde" title="Logo Ana Costa Saúde">
            </div>
            <div class="col-12 col-md-6">
                <p>O <strong>Plano de Saúde Ana Costa</strong> é um plano criado pelo hospital Ana Costa na década de 1970 e em 2017 passou a pertencer ao UnitedHealth Group, o mesmo Grupo Amil. Referência em qualidade e organização na Baixada santista, o plano oferece cobertura completa conforme o Rol da ANS, possui como principal credenciado o Hospital Ana Costa, com sistema integrado de atendimento nas cidades de Santos, Guarujá, Cubatão, São Vicente e Praia Grande.</p>
                <p>O Hospital Ana Costa conta uma equipe multiprofissional capacitada que acolhe os pacientes dentro das melhores práticas assistenciais e de governança clínica, e como resultado dessa excelência no atendimento, a instituição foi reconhecida pela Organização Nacional de Acreditação (ONA) com o selo ONA 1, o qual certifica hospitais que cumprem os padrões diferenciados de qualidade e segurança, incluindo aspectos estruturais e assistenciais.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Ana Costa Saúde</h2>
                <ul class="mx-1">
                  <li>Pronto atendimento adulto e pediátrico em toda região de abrangência.</li>
                  <li>Desconto em farmácias parceiras.</li>
                  <li>Rede verticalizada.</li>
                  <li>Telemedicina para consultas eletivas, com hora marcada e plataforma exclusiva. Durante a consulta o médico poderá realizar diagnósticos, receitar medicamentos e exames.</li>
                  <li>Programas de Saúde para emagrecimento, tabagismo, unidade postural, planejamento reprodutivo.</li>
                  <li>Planos com coparticipação de 30% ou coparticipação parcial (terapias).</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
