...
<head>
    ...
    <title>Astro Vida e Saúde | Garantia de Saúde</title>
    ...
    <meta name="description"  	content="Garantia de Saúde, há 40 anos oferecendo planos de saúde a um custo justo com atendimento ético e humanizado." />
    <meta name="keywords" 		content="Garantia de saúde, planos de saúde garantia de saúde, convênio médico garantia de saúde, garantia saúde " />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Garantia de Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Garantia de Saúde, há 40 anos oferecendo planos de saúde a um custo justo com atendimento ético e humanizado.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Garantia de Saúde</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Garantia de Saúde<br>
                <span class="h2">Planos de Saúde acessíveis, com atendimento ético e humanizado.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/garantia-de-saude.webp" alt="Logo Garantia de Saúde" title="Logo Garantia de Saúde">
            </div>
            <div class="col-12 col-md-6">
              <p>A <strong>Garantia de Saúde</strong> surgiu há 40 anos com o propósito de oferecer um plano de saúde com custo acessível, atendimento ético e humanizado. Suas atividades foram iniciadas no extremo leste paulistano, mas expandiu sua rede de atendimento para as regões do Alto Tietê e Guarulhos.</p>
              <p>O plano <strong>Garantia de Saúde</strong> dispõe de hospital e ambulatório de especialidades médicas e exames próprios proporcionando atendimento customizado.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Garantia de Saúde</h2>
                <ul class="mx-1">
                  <li>Preços acessíveis.</li>
                  <li>Aplicativo exclusivo para clientes.</li>
                  <li>Consultas médicas eletivas, exames em regime ambulatorial em 30 dias.</li>
                  <li>Hospitais, laboratórios e clínicas médicas em toda a capital paulista, regiões da Grande São Paulo e Alto Tietê.</li>
                  <li>Cobertura para urgência e emergência em até 24 horas.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
