    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Hapvida Saúde</li>
            </ol>
        </nav>
		  <div class="clear">
            <h1 class="title">Hapvida<br>
        ...
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Hapvida</h2>
                <ul class="m-x-1">
        ...
        <h2 class="subtitle">Hospitais de Destaque da Hapvida</h2>
        <div class="operadoras">
            <div>
        <?php
            $qsqlHospitais = "SELECT DISTINCT TE.id, TE.slug, TE.nome_abrev, TE.numero, TE.complemento, TE.telefone, TC.cep, TC.tipo_logradouro, TC.logradouro,TB.bairro, TD.cidade
                                FROM tb_empresa as TE
                                INNER JOIN tb_empresas_planos TEP on TEP.id_empresa = TE.id
                                INNER JOIN tb_plano TP on TEP.id_plano = TP.id
                                INNER JOIN cepbr_endereco TC on TE.cep = TC.cep
                                INNER JOIN cepbr_bairro TB on TC.id_bairro = TB.id_bairro
                                INNER JOIN cepbr_cidade TD on TC.id_cidade = TD.id_cidade
                                where TP.id_operadora=7 order by TE.nome_abrev ASC";
            ...
            <hr m-y-5>
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle"> <a class="link_operadoras" href="../../perguntasERespostas/#carencias" target="new">Carências | Hapvida</a></h2>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle">Documentos necessários para análise de redução de <a class="link_operadoras" href="../../perguntasERespostas/#carencias" target="new">Carências</a>:</h2>
                        <ul>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle">Valores de <a class="link_operadoras" href="../../perguntasERespostas/#coparticipacao" target="new">Coparticipação</a> | Hapvida</h2>
                            <table class="table table-sm table-striped table-responsive">
                                <thead>
                                    <tr>
                        ...
                        <p>Os valores de <a class="link_operadoras" href="../../perguntasERespostas/#copartcipacap" target="new">coparticipação</a> são por atendimento. Serão acumulados durante o mês e cobrados mensalmente junto ao boleto da mensalidade do plano.</p>
                    </div>
                </div>
                <hr>
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle"> <a class="link_operadoras" href="../../perguntasERespostas/#area_comercializacao" target="new">Área de comercialização</a> e de atendimento - Hapvida</h2>
                        <h3>Nosso Plano</h3>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle"> <a class="link_operadoras" href="../../perguntasERespostas/#reembolso" target="new">Reembolso</a> Hapvida</h2>
                            <p>A Hapvida Saúde não trabalha com <a class="link_operadoras" href="../../perguntasERespostas/#reembolso" target="new">reembolso</a>.</p>
                    </div>
                </div>
                <hr>
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle">Quem pode aderir ao plano e documentos necessários</h2>
                        <h3> <a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Pessoa Física</a></h3>
                        <h4>Titular</h4>
                        ...
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Plano por Adesão</a></h3></h3>
                        <h4>Titular</h4>
                        ...
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Pessoa Jurídica</a></h3>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle">Condições comerciais | Regras para contratação</h2>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Plano Pessoa Física</a></h3>
                        ...
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Plano por Adesão</a></h3>
                        ...
                        <p>Com a Astro Saúde esse processo é rápido e você consegue acompanhar cada passo.</p>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Plano Empresarial</a></h3>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle"> <a class="link_operadoras" href="../../perguntasERespostas/#vigencia" target="new">Vigência</a>, prazo para início do plano e vencimentos</h2>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Pessoa Física</a></h3>
                        <p>A <a class="link_operadoras" href="../../perguntasERespostas/#vigencia" target="new">vigência</a>, que é a data de início do plano, pode ser escolhida pelo cliente a partir de 4 dias úteis após a conclusão do formulário de contratação e envio das cópias dos documentos. A vigência não pode ocorrer em finais de semana ou feriados.</p>
                        <p>Os <a class="link_operadoras" href="../../perguntasERespostas/#vencimento" target="new">vencimentos</a> podem ser escolhidos dentro das opções disponíveis para data de elaboração da proposta. </p>
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-responsive">
                                <thead>
                                    <tr>
                        ...
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos por Adesão</a></h3>
                        <p>Você pode escolher 3 (três) <a class="link_operadoras" href="../../perguntasERespostas/#vigencia" target="new">vigência</a>: 5, 15 ou 25. A data de vencimento será a mesma data da vigência. O primeiro pagamento a ser feito refere-se a taxa de angariação qye deverá ser feito a Astro Saúde por meio de um boleto correspondente a 90% do valor da primeira mensalidade cujo vencimento será de 5 dias corridos da data de assinatura do contrato. A primeira mensalidade do plano será cobrada pela Administradora do plano (Affix, Corpe ou Qualicorp) por meio de boleto bancário. </p>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Empresariais</a></h3>
                        <p>A <a class="link_operadoras" href="../../perguntasERespostas/#vigencia" target="new">vigência</a>, data de início do plano, pode ser escolhida pelo cliente a partir de 6 dias úteis após o preenchimento do formulário de contratação e envio das cópias dos documentos, a <a class="link_operadoras" href="../../perguntasERespostas/#vigencia" target="new">vigência</a> não pode ocorrer em finais de semana ou feriados.</p>
                        <p>Os <a class="link_operadoras" href="../../perguntasERespostas/#vencimento" target="new">vencimentos</a> podem ser escolhidos dentro das opções disponíveis para data de elaboração da proposta. </p>
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-responsive">
                                <thead>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle"><a class="link_operadoras" href="../../perguntasERespostas/#fidelidade" target="new">Fidelidade</a>, regras para cancelamento</h2>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Pessoa Física</a></h3>
                        <p>Os planos pessoa física da Hapvida possuem <a class="link_operadoras" href="../../perguntasERespostas/#fidelidade" target="new">fidelidade</a>de 12 meses, caso o beneficiário deseje rescindir o contrato antes de completar o período de 12 meses, haverá multa rescisória de 10% (dez) sobre o valor das mensalidades que restem para completar o período de 12 (doze) meses.</p>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos por Adesão</a></h3>
                        <p>Os planos por adesão da Hapvida não possuem <a class="link_operadoras" href="../../perguntasERespostas/#fidelidade" target="new">fidelidade</a>, podendo ser cancelados a qualquer momento sem cobrança de multa, o cancelamento do plano deve ser solicitado direto na Administradora do plano (Affix, Corpe ou Qualicorp), o pedido pode ser realizado pelo telefone na central de atendimento.</p>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Empresariais</a></h3>
                        <p>Os planos empresariais da Hapvida possuem <a class="link_operadoras" href="../../perguntasERespostas/#fidelidade" target="new">fidelidade</a> de 12 meses, caso o plano seja cancelado antes desse período estará sujeito a multa no valor igual à média das 03(três) últimas faturas imediatamente anteriores à rescisão.</p>
                    </div>
                </div>
                <hr>
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle">Taxas para contratação</h2>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Pessoa Física</a></h3>
                ...
                <div class="conteudo-operadoras">
                    <div class="subconteudo">
                        <h2 class="subtitle"><a class="link_operadoras" href="../../perguntasERespostas/#reajuste" target="new"> Reajuste</a> das mensalidades | Hapvida</h2>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Pessoa Física</a></h3>
                        <h4>Reajuste Financeiro</h4>
                        <p>O índice de reajuste determinado pela <a class="link_operadoras" href="https://www.gov.br/ans/pt-br" target="_blank"> ANS</a> (Agência Nacional de Saúde), ocorrem na data de aniversário de assinatura do contrato.</p>
                        ...
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos por Adesão</a></h3>
                        <h4>Reajuste Financeiro</h4>
                        <p>O reajuste é calculado com base na <a class="link_operadoras" href="../../perguntasERespostas/#sinistralidade" target="new">sinistralidade</a> do contrato da Hapvida com a Administradora de Benefício (Affix, Corpe e Qualicorp) e ocorre no mês de novembro independente da data de adesão ao plano. </p>
                        <h3><a class="link_operadoras" href="../../perguntasERespostas/#tipos_planos" target="new">Planos Empresariais</a></h3>
                        <h4><a class="link_operadoras" href="../../perguntasERespostas/#reajuste" target="new">Reajuste</a> Financeiro</h4>
                        <p>Para empresas até 29 vidas, o índice é calculado sobre a <a class="link_operadoras" href="../../perguntasERespostas/#sinistralidade" target="new">sinistralidade</a> de toda carteira de clientes empresariais da Hapvida de 2 a 29 vidas, e ocorre na data de aniversário do contrato</p>
                        <h4><a class="link_operadoras" href="../../perguntasERespostas/#reajuste" target="new">Reajuste</a> por Faixa Etária</h4>
                        <p>O <a class="link_operadoras" href="../../perguntasERespostas/#reajuste" target="new">reajuste</a> por faixa etária ocorre aos 18 anos e de 4 em 4 anos até o beneficiário completar 59 anos. Os percentuais são fixos e estão definidos no contrato.</p>
                    </div>
                </div>
