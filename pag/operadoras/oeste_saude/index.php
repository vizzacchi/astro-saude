...
<head>
    ...
    <title>Astro Vida e Saúde | Oeste Saúde</title>
    ...
    <meta name="description"  	content="Oeste Saúde o plano de saúde ideal para quem reside em Presidente Prudente e região." />
    <meta name="keywords" 		content="UnoesteSaúde, Plano de Saúde Oeste Saúde, Oeste Saúde, Convênio Médico Oeste Saúde, Planos Oeste Saúde, Plano de Saúde Presidente Prudente" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Oeste Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Oeste Saúde o plano de saúde ideal para quem reside em Presidente Prudente e região.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Oeste Saúde</li>
            </ol>
        </nav>

		  <div class="clear"><h1 class="text-center">Oeste Saúde<br>
                <span class="h2">O plano de saúde ideal para quem reside em Presidente Prudente e Região.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/santa-casa-maua.webp" alt="Logo Santa Casa Mauá" title="Logo Santa Casa Mauá">
            </div>
            <div class="col-12 col-md-6">
              <p>Fundada em 1997, a antiga UnoesteSaúde era um plano de saúde com atendimento exclusivo dentro do então Hospital Universitário, vinculado à instituição de ensino Unoeste.</p>
              <p>Em 2008, o Hospital Universitário foi desapropriado da universidade e passou a ser denominado Hospital Regional; mediante a essa mudança a operadora teve que reformular seu modelo de negócio e para isso credenciou novos médicos, laboratórios e hospitais.</p>
              <p>Após toda essa expansão, a operadora reformulou sua identidade visual e passou a se chamar <strong>Oeste Saúde</strong>; desde então segue sua expansão e atua em dois estados: São Paulo, nas cidades de Adamantina, Álvares Machado, Dracena, Iepê, Junqueirópolis, Martinópolis, Mirante do Paranapanema, Osvaldo Cruz, Paraguaçu Paulista, Panorama, Pirapozinho, Presidente Bernardes, Presidente Epitácio, Presidente Prudente, Presidente Venceslau, Primavera, Rancharia, Regente Feijó, Santo Anastácio, Teodoro Sampaio, Tupi Paulista; Mato Grosso do Sul nas cidades de Anaurilândia, Bataguassu, Brasilândia e Três Lagoas.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
