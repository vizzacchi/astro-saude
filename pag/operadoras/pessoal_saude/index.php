...
<head>
    ...
    <title>Astro Vida e Saúde | Pessoal Saúde</title>
    ...
    <meta name="description"  	content="Pessoal Saúde há quase 50 anos no mercado de planos de saúde, prestando atendimento humanizado e ampla rede-credenciada." />
    <meta name="keywords" 		content="pessoal saúde, planos de saúde pessoal saúde, convênio médico pessoal saúde " />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Pessoal Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Pessoal Saúde há quase 50 anos no mercado de planos de saúde, prestando atendimento humanizado e ampla rede-credenciada.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pessoal Saúde</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Pessoal Saúde<br>
                <span class="h2">Há quase 50 anos oferecendo planos de saúde com atendimento humanizado.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/pessoal-saude.webp" alt="Logo Pessoal Saúde" title="Logo Pessoal Saúde">
            </div>
            <div class="col-12 col-md-6">
              <p><strong>Pessoal Saúde</strong> é uma empresa que oferece planos de saúde há quase 50 anos, prestando atendimento humanizado, com profissionais especializados e rede credenciada altamente qualificada.</p>
              <p>Iniciou suas atividades comercializando planos de saúde em Juiz de Fora e região, mas expandiu suas atividades para São Paulo e região.</p>
              <p>Os planos de saúde comercializados pela <strong>Pessoal Saúde</strong> possuem segmentação Ambulatorial + Hospitalar com Obstetrícia e abrangência nos municípios de Santo André, São Bernardo do Campos, São Caetano do Sul, Ribeirão Pires, Mauá e São Paulo capital.</p>

            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Pessoal Saúde</h2>
                <ul class="mx-1">
                  <li>Possui aplicativo para facilitar a comunicação do beneficiário com a Pessoal Saúde.</li>
                  <li>Todos os planos possuem acomodação enfermaria.</li>
                  <li>Não há cobrança de coparticipação.</li>
                  <li>Suporte aos beneficiários por meio de WhatsApp.</li>
