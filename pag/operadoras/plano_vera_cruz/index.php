...
<head>
    ...
    <title>Astro Vida e Saúde | Plano Vera Cruz</title>
    ...
    <meta name="description"  	content="Plano Vera Cruz, pioneiro na cidade de Campinas a mais de 55 anos integrando o atendimento do Hospital Vera Cruz ao plano de saúde." />
    <meta name="keywords" 		content="Vera Cruz Saúde, Plano de Saúde Vera Cruz Saúde, Convênio Médico Vera Cruz, Plano Vera Cruz, Plano de Saúde Campinas" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Vera Cruz Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Plano Vera Cruz, pioneiro na cidade de Campinas a mais de 55 anos integrando o atendimento do Hospital Vera Cruz ao plano de saúde.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Vera Cruz Saúde</li>
            </ol>
        </nav>

		  <div class="clear"><h1 class="text-center">Vera Cruz Saúde<br>
                <span class="h2">O plano pioneiro de Campinas, o plano do hospital Vera Cruz.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/plano-vera-cruz.webp" alt="Logo Plano de Saúde Vera Cruz" title="Logo Plano de Saúde Vera Cruz">
            </div>
            <div class="col-12 col-md-6">
              <p>O plano de saúde <strong>Vera Cruz</strong> foi criado há mais de 55 anos, fruto da iniciativa dos fundadores do <strong>Vera Cruz Hospital</strong> e é o pioneiro na região de Campinas. O objetivo do plano é integrar os atendimentos de seus hospitais, facilitando ainda mais o atendimento e tratamento de todos os seus beneficiários, ou seja, algo que é comum a todos é o acesso aos três principais hospitais da região.</p>
              <p>O plano de saúde <strong>Vera Cruz</strong> atua na prevenção de doenças, no diagnóstico precoce e na promoção e educação para a saúde.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Vera Cruz</h2>
                <ul class="mx-1">
                  <li>Atendimentos de urgência e emergência.</li>
                  <li>Cobertura hospitalar, ambulatorial, obstetrícia.</li>
                  <li>Uso de tecnologia de ponta e profissionais altamente qualificados.</li>
                  <li>Atendimento humanizado.</li>
                  <li>Portal do Beneficiário com acesso a dados cadastrais, 2ª via de boleto e cartão, demonstrativos, rede credenciada e descredenciada e outros serviços.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
