    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Porto Saúde</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Porto Saúde<br>
        ...
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Porto Saúde</h2>
                <ul class="mx-1">
        ...
        <?php
            $qsqlHospitais = "SELECT DISTINCT TE.id, TE.slug, TE.nome_abrev, TE.numero, TE.complemento, TE.telefone, TC.cep, TC.tipo_logradouro, TC.logradouro,TB.bairro, TD.cidade
                              ...
                              where TP.id_operadora=26 order by TE.nome_abrev ASC";
      ...
      <h2 class="subtitle">Promoção a Saúde | Porto Saúde</h2>
        <ul>
        ...
        <h2 class="subtitle">Canais Exclusivos de Atendimento ao Cliente</h2>
