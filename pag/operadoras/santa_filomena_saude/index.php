...
<head>
    ...
    <title>Astro Vida e Saúde | Santa Filomena Saúde</title>
    ...
    <meta name="description"  	content="Santa Filomena Saúde, sua melhor escolha em Rio Claro." />
    <meta name="keywords" 		content="Santa Filomena Saúde, Plano de Saúde Santa Filomena, Convênio Médico Santa Filomena" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Santa Filomena Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Santa Filomena Saúde, sua melhor escolha em Rio Claro.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Santa Filomena Saúde</li>
            </ol>
        </nav>

		  <div class="clear"><h1 class="text-center">Santa Filomena Saúde<br>
                <span class="h2">Sua melhor escolha em planos de saúde na cidade de Rio Claro.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/santa-filomena-saude.webp" alt="Logo Plano Santa Filomena Saúde" title="Logo Plano Santa Filomena Saúde">
            </div>
            <div class="col-12 col-md-6">
              <p>O plano de saúde <strong>Santa Filomena</strong> atua na cidade de Rio Claro, estado de São Paulo, e oferece uma ampla rede de serviços próprios e credenciados para atendimento dos seus usuários com um vasto grupo de profissionais da área da saúde, os quais prestam assistência em seus consultórios particulares, em atendimento ambulatorial e hospitalar.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Santa Filomena</h2>
                <ul class="mx-1">
                  <li>Hospital e Maternidade Próprios</li>
                  <li>Centros Médicos Especializados</li>
                  <li>Centro de Diagnósticos e Imagens</li>
                  <li>Cirurgias</li>
                  <li>Hemodinâmica</li>
                  ...
                  <li>Nutrição</li>
                  <li>Unidade Cárdio Respiratória</li>
                  <li>Laboratório de Análises Clínicas</li>
                  <li>Pronto Atendimento Clínico e Pediátrico 24 horas</li>
                  <li>Planos com taxa de coparticipação</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
