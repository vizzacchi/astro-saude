...
<head>
    ...
    <title>Astro Vida e Saúde | São Cristovão Saúde</title>
    ...
    <meta name="description"  	content="São Cristovão Saúde, sua referência em saúde na região leste de São Paulo, com planos completos e acessíveis." />
    <meta name="keywords" 		content="São Cristovão Saúde, Plano de Saúde São Cristovão Saúde, Convênio São Cristovão Saúde, Convênio Médico São Cristovão Saúde, Plano de Saúde Zona Leste São Paulo, Plano Zona Leste SP" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | São Cristovão Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="São Cristovão Saúde, sua referência em saúde na região leste de São Paulo, com planos completos e acessíveis.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">São Cristovão Saúde</li>
            </ol>
        </nav>

		  <div class="clear"><h1 class="text-center">São Cristovão Saúde<br>
                <span class="h2">Sua referência em planos de saúde na região leste de São Paulo.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/sao-cristovao-saude.webp" alt="Logo São Cristovão Saúde" title="Logo São Cristovão Saúde">
            </div>
            <div class="col-12 col-md-6">
              <p>A Associação de Beneficência e Filantropia São Cristóvão possui 107 anos e é uma referência em saúde na região leste de São Paulo. Possui planos de saúde com bom custo-benefício e opções de coparticipação.</p>
              <p>A rede de hospitais São Cristóvão é considerada uma das melhores redes do mercado devido ao amplo atendimento nas redes credenciadas na zona leste da capital paulista.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos São Cristovão Saúde</h2>
                <ul class="mx-1">
                  <li>Centro de Atenção Integral à Saúde, o CAIS, promove programas com foco na prevenção e na reabilitação de seus beneficiários. Dentre as ações estão grupos de relaxamento, de assistência ao tabagista e fisioterapia.</li>
                  <li>Ambulatórios próprios com diferentes especialidades médicas, inclusive, possui um atendimento especial para a saúde da mulher com serviços de estética e dermatologia.</li>
                  <li>Contratação opcional do resgate <strong>São Cristóvão Saúde</strong>: com um pequeno investimento a mais na mensalidade, os beneficiários passam a ter acesso ao atendimento de urgência domiciliar, bem como orientações médicas por telefone de diversas especialidades.</li>
                  <li>Hotel Recanto São Cristóvão: o Grupo <strong>São Cristóvão</strong> oferece um desconto de 20% aos beneficiários para aproveitarem o Hotel Recanto São Cristóvão, em Campos do Jordão. </li>
              </ul>
            </div>
            <div class="col-12 col-md-6">
