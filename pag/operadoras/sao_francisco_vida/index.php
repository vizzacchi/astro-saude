...
<head>
    ...
    <title>Astro Vida e Saúde | Notredame Intermédica</title>
    ...
    <meta name="description"  	content="Notredame Intermédica o plano de saúde pioneiro em medicina preventiva, a maior rede própria do Brasil." />
    <meta name="keywords" 		content="Notredame Intermédica, intermédica, planos de saúde GNDI, planos de saúde intermédica, planos de saúde notredame, convênio Intermédica, planos intermedica" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Notredame Intermédica">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Notredame Intermédica o plano de saúde pioneiro em medicina preventiva, a maior rede própria do Brasil.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Notredame Intermédica</li>
            </ol>
        </nav>

		  <div class="clear"><h1 class="text-center">Notredame Intermédica<br>
                <span class="h2">A maior rede própria do Brasil, o maior portfólio de produtos com planos regionais e nacionais.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/notredame-intermedica.webp" alt="Logo Notredame Intermédica" title="Logo Notredame Intermédica">
            </div>
            <div class="col-12 col-md-6">
              <p>A <strong>NotreDame Intermédica</strong> foi fundada em 1968 e é a pioneira em Medicina Preventiva. Os atendimentos aos beneficiários ocorrem em Rede Credenciada e em sua Rede Própria, a qual está presente em todas as regiões do país, tanto que é a Companhia com a maior Rede Própria de atendimento no Brasil. </p>
              <p>Em 2022, a <strong>NotreDame Intermédica</strong> em união de negócios com o Sistema HapVida, se tornou uma das maiores operadora de saúde verticalizadas do mundo, com cerca de 16 milhões de clientes e participação de 18% no mercado em planos de saúde.</p>
              <p>Os planos de saúde da <strong>NotreDame</strong> possuem cobertura regional e nacional e a Companhia conta com uma estrutura composta por 84 Hospitais, 335 Centros Clínicos, 78 Pronto Atendimentos, 269 Unidade de Diagnóstico por Imagem e Pontos de Coleta, 17 Unidades de Medicina Preventiva e 3 Centros de Saúde dedicados exclusivamente ao público a partir de 50 anos. As Unidades de Rede Própria possuem diferentes certificações, tanto os hospitais em São Paulo, como os no interior de São Paulo, além disso, contam com hospital maternidade reconhecidamente qualificada: a acreditação internacional Qmentum; a ONA (Organização Nacional de Acreditação) – Níveis 1 a 3; a CQH (Controle de Qualidade Hospitalar), a ISSO 14.001, que regulamenta as relações com o meio ambiente; e a ISSO 9001:2008, de gestão e garantia da qualidade.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Oeste Saúde</h2>
                <ul class="mx-1">
                  <li>Telemedicina.</li>
                  <li>Atendimento em rede própria.</li>
                  <li>Cobertura ambulatorial e hospitalar com obstetrícia.</li>
                  <li>Atendimento de urgência e emergência pelo sistema ABRANGE.</li>
                  <li>Site de fácil navegação que permite aos beneficiários acesso à diversas informações.</li>
                  <li>Programas de prevenção para diversos públicos como crianças obesas ou com sobrepeso, gestante e idosos.</li>
                  <li>Programa de prevenção Oeste Saúde Mental destinados a todos os beneficiários que apresentam problemas psicológicos. </li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
