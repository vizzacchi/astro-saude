...
<head>
    ...
    <title>Astro Vida e Saúde | Sobam Saúde</title>
    ...
    <meta name="description"  	content="Grupo Sobam, sua melhor escolha em planos de saúde na região de Jundiaí." />
    <meta name="keywords" 		content="Sobam, planos de saúde sobam, planos sobam, convênios medicos sobam, convênios sobam, planos de saúde jundiaí">

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Sobam Saúde">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Grupo Sobam, sua melhor escolha em planos de saúde na região de Jundiaí.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
		  ...
		  <div class="clear"><h1 class="text-center">Sobam Saúde<br>
                <span class="h2">Referência em planos de saúde na região de Jundiaí.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/sobam.webp" alt="Logo Plano Sobam Saúde" title="Logo Plano Sobam Saúde">
            </div>
            <div class="col-12 col-md-6">
              <p>O <strong>Grupo Sobam</strong> foi fundado em 1968 por quatro profissionais médicos que doaram suas vidas em prol de um projeto audacioso de tal forma que o Grupo Sobam se tornou referência em qualidade na região onde atua: Cabreúva, Campo Limpo Paulista, Itupeva, Jundiaí, Louveira, Várzea Paulista. Atualmente a Sobam integra o UnitedHealth Group; esse grupo nada mais é do que a maior e mais diversificada empresa do setor de saúde do mundo, com sede nos Estados Unidos, que oferece benefícios e serviços em mais de 130 países.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Sobam</h2>
                <ul class="mx-1">
                  <li>Qualidade assistencial certificada pela ONA nível 3.</li>
                  <li>Consultórios, clínicas, hospital próprio e serviços terceirizados, administrados por técnicas comprovadas de gestão.</li>
                  <li>Líder de implantação de produtos de alta complexidade na região de Jundiaí.</li>
                  <li>Acesso ao Hospital Pitangueiras, que é referência na região.</li>
                  <li>Programas de Saúde: Geriarte voltado para a terceira idade, Amigo do Pulmão – programa antitabagismo, Paco – programa de anticoagulação, GDC (Grupo de Dor Crônica) – programa com foco no gerenciamento de dores crônicas no esqueleto axial, Programa de Planejamento reprodutivo – apoio a pessoas de todos os gêneros na escolha do método contraceptivo mais adequado ao seu estilo de vida, GAPO (Grupo de Apoio ao Paciente Obeso) – programa de emagrecimento saudável para pacientes com obesidade graus II e III.</li>
                  <li>Descontos em farmácias parceiras.</li>
                  <li>Telemedicina para consultas agendadas em 16 especialidades.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
