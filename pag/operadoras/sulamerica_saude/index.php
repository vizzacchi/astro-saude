    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Sulamérica Saúde</li>
            </ol>
        </nav>

		  <div class="clear">
		  <div class="clear">
            <h1 class="title">Sulamérica Saúde<br>
        ...
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Sulamérica Saúde</h2>
                <ul class="mx-1">
        ...
        <h2 class="subtitle">Sulamérica Saúde Ativa</h2>
        ...
        <h2 class="subtitle">Reembolso Sulamérica Saúde</h2>
        ...
        <h4 class="my-2">Reembolso para planos empresariais:</h4>
        ...
        <div class="operadoras">
			<h2 class="subtitle" class="my-3">Hospitais de Destaque da Sulamérica Saúde</h2>
            <div>
        <?php
            $qsqlHospitais = "SELECT DISTINCT TE.id, TE.slug, TE.nome_abrev, TE.numero, TE.complemento, TE.telefone, TC.cep, TC.tipo_logradouro, TC.logradouro,TB.bairro, TD.cidade
                                ...
                                where TP.id_operadora=9 order by TE.nome_abrev ASC";
