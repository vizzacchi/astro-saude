...
<head>
    ...
    <title>Astro Vida e Saúde | Total Medcare</title>
    ...
    <meta name="description"  	content="Total Medcare o único plano de saúde com atendimento completo no hospital Adventista com consultas consultas médicas, exames, procedimentos ambulatoriais, tratamento, pronto socorro e internação." />
    <meta name="keywords" 		content="Sistema de saúde adventista, Total Medcare, planos de saúde total medcare, total med care, convênio médico total medcare, plano de saúde do hospital adventista, hospital adventista " />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Total Medcare">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Total Medcare o único plano de saúde com atendimento completo no hospital Adventista com consultas consultas médicas, exames, procedimentos ambulatoriais, tratamento, pronto socorro e internação.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Total Medcare</li>
            </ol>
        </nav>

		  <div class="clear">Total Medcare<br>
                <span class="h2">O único plano de saúde com atendimento completo no hospital Adventista.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/total-medcare.webp" alt="Logo Total Medcare" title="Logo Total Medcare">
            </div>
            <div class="col-12 col-md-6">
              <p>A <strong>Total MedCare</strong> é uma operadora de plano de saúde que faz parte do <strong>Sistema Adventista de Saúde</strong>, atende na grande São Paulo e região; trata-se do único plano de saúde com atendimento completo no Hospital Adventista com consultas médicas, exames, procedimentos ambulatoriais, tratamento, pronto socorro e internação.</p>
              <p>O Hospital Adventista possui mais de 75 anos e recebeu o selo da ONA por prezar pelos protocolos de segurança e pela qualidade no atendimento dos seus pacientes. O plano também conta com dois Centros Médicos próprios com pronto socorro 24 horas: o Centro Médico Unidade Liberdade e o Centro Médico Unidade Sul, este localizado no bairro Capão Redondo. Portanto, além da rede própria, o plano Total MedCare possui uma ampla rede credenciada a qual varia de acordo com o plano contratado. </p>

            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos da Total Medcare</h2>
                <ul class="mx-1">
                  <li>Atendimento completo no hospital Adventista.</li>
                  <li>Diversos canais de atendimento para os beneficiários, inclusive moderno aplicativo.</li>
                  <li>Coleta de exames em domicílio.</li>
                  <li>Teleconsultas.</li>
                  <li>Orientação médica 24 h por dia.</li>
                  <li>APH para emergências.</li>
                  <li>Descontos de 5% a 25% em remédios e perfumaria na sprincipais redes de farmácia: Drogaria SP, Droga Raia, Drogarias Pacheco e Drogasil.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
