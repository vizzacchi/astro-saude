...
<head>
    ...
    <title>Astro Vida e Saúde | Unimed Jundiaí</title>
    ...
    <meta name="description"  	content="Unimed Jundiaí, há mais de 40 anos oferecendo planos de saúde com ampla rede credenciada e excelência no atendimento." />
    <meta name="keywords" 		content="Unimed Jundiaí, Planos de Saúde Unimed Jundiaí, Convênio Médico Unimed Jundiaí, Plano de Saúde em Jundiaí" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Unimed Jundiaí">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Unimed Jundiaí, há mais de 40 anos oferecendo planos de saúde com ampla rede credenciada e excelência no atendimento.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Unimed Jundiaí</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Unimed Jundiaí<br>
                <span class="h2">Há mais de 40 anos oferecendo planos de saúde com ampla rede credenciada e excelência no atendimento.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/unimed-jundiai.webp" alt="Logo Unimed Jundiaí" title="Logo Unimed Jundiaí">
            </div>
            <div class="col-12 col-md-6">
              <p>A <strong>Unimed Jundiaí</strong> é uma cooperativa de trabalho médico fundada na década de 80 que oferece planos de saúde com ampla rede credenciada com médicos, hospitais, clínicas, laboratórios e serviços de imagem, com foco na valorização do profissional e na prática médica de forma ética, justa e honesta.</p>
              <p>Esse modelo de administração em que os próprios médicos gerenciam os serviços prestados, sem intermediários, denominado de cooperativa de trabalho médico se fortaleceu e conquistou seu espaço no mercado de tal forma que hoje já existem 60 cooperativas médicas Unimed em nosso país. </p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Unimed Jundiaí</h2>
                <ul class="mx-1">
                  <li>463 médicos cooperados.</li>
                  <li>Área de atuação: Itupeva, Louveira, Jundiaí, Jarinu, Várzea Paulista, Campo Limpo Paulista, Francisco Morato, Franco da Rocha, Cajamar e Cabreúva.</li>
                  <li>5 clínicas regionais próprias: Louveira, Várzea Paulista, Itupeva, Cabreúva e Cajamar -  Unidade em Polvilho.</li>
                  <li>47 especialidades.</li>
                  <li>70 clínicas credenciadas.</li>
                  <li>Laboratório próprio, além dos credenciados.</li>
                  <li>Pronto-Atendimento Infantil 24 horas.</li>
                  <li>Pronto-Atendimento Adulto 24 horas (clínica médica, ortopedia, cardiologia e cirurgia geral).</li>
                  <li>Hospital próprio e mais 08 hospitais credenciados.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
