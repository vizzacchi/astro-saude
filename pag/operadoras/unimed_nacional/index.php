...
<head>
    ...
    <title>Astro Vida e Saúde | Unimed Nacional</title>
    ...
    <meta name="description"  	content="Unimed Nacional, tenha acesso a maior rede credenciada do Brasil, com a Unimed Nacional você têm atendimento eletivo em todas Unimeds do Brasil." />
    <meta name="keywords" 		content="Unimed Nacional, Plano de Saúde Unimed Nacional, Convênio Unimed Nacional, Convênio Médica Unimed Nacional, Planos Unimed Nacional, Planos Central Nacional das Unimeds" />

    <!-- FACEBOOK -->
    <meta property="og:locale" 			content="pt_BR">
    <meta property="og:url" 			content="https://www.astrosaude.com.br">
    <meta property="og:title" 			content="Astro Vida e Saúde | Unimed Nacional">
    <meta property="og:site_name" 		content="Astro Vida e Saúde">
    <meta property="og:description" 	content="Unimed Nacional, tenha acesso a maior rede credenciada do Brasil, com a Unimed Nacional você têm atendimento eletivo em todas Unimeds do Brasil.">
    ...
    <section class="container main-home">
      <!--------------- Breadcumb ---------------->
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
            ...
            <li class="breadcrumb-item active" aria-current="page">Unimed Nacional</li>
            </ol>
        </nav>

		  <div class="clear">
            <h1 class="title">Unimed Nacional<br>
                <span class="h2">A maior rede credenciada do Brasil, atendimento eletivo em todo sistema Unimed.</span></h1>
            <!-- Listagem das operadoras -->
            <div class="row m-5">
            <div class="col-12 col-md-6 d-flex justify-content-center align-items-center mb-2">
                <img src="../../../img/logos/unimed-nacional.webp" alt="Logo Unimed Nacional" title="Logo Unimed Nacional">
            </div>
            <div class="col-12 col-md-6">
              <p>A primeira Unimed foi fundada em 1967, em Santos – SP, por um grupo de médicos insatisfeitos com as precárias condições de atendimento oferecidas pelo sistema público de saúde. Diante desse cenário, esse grupo iniciou uma exploração comercial do setor e criou um modelo inédito denominado cooperativismo de trabalho médico por meio do qual resgatou a ética na prática da medicina, oferecendo condições dignas de trabalho ao profissional médico e proporcionando qualidade no atendimento médico hospitalar a um preço justo. </p>
              <p>Em 1998 representantes de diversas Singulares Unimed (Unimeds que atuam no âmbito dos municípios) se reuniram e constituíram a União Nacional Cooperativa, posteriormente chamada de Central Nacional Unimed (CNU), a qual em 2022, como parte do planejamento estratégico, altera seu nome fantasia e passou a atender por Unimed Nacional.</p>
            </div>
        </div>
        <div class="row m-3">
            <div class="col-12 col-md-6">
                <h2 class="subtitle">Diferenciais dos Planos Unimed Nacional</h2>
                <ul class="mx-1">
                  <li>Atendimento eletivo em todo sistema Unimed</li>
                  <li>Em novembro de 2022 recebeu da Agência Nacional de Saúde Suplementar a homologação da Acreditação Nível 1 – Ouro da RN 507, maior patamar desse reconhecimento.</li>
                  <li>Em 2018 recebeu a certificação da ISSO 9001:2015 a qual estabelece padrões de referência para gestão da qualidade.</li>
                  <li>Diversos canais digitais por onde o beneficiário acessa os principais serviços como indicação de rede credenciada, dados sobre o plano, 2ª via de boleto, consulta de autorizações e muito mais.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6">
