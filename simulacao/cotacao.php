...
<header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav nav-douglas mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../pag/">Simulação</a>
            </li>
            <li class="nav-item">
  ...
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="m-5">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="../simulacao">Simulação</a></li>
  ...
  <?php
  $qsqlCotacao= "SELECT TB.*, TP.*, TE.logo as 'logoOper', TA.logo as 'logoAdm' FROM `tb_tabela` as TB
                    ...
                    INNER JOIN tb_cidade_regiao TCR on TCR.id_regiao = TB.id_regiao
                    WHERE
          ...
          if($rsCotacao = mysqli_query($conn,$qsqlCotacao)){
            ...
            while($regCotacao = mysqli_fetch_assoc($rsCotacao)){
              if(($idOperadora!=$regCotacao['id_operadora'] &&
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#op<?php echo $regCotacao['id_operadora'];?>Ad<?php echo $regCotacao['id_administradora'];?>" aria-expanded="false" aria-controls="collapseOne">
                        <?php
              ...
              <div class="accordion" id="planoAc<?php echo $idPlano;?>">
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#plano<?php echo $idPlano;?>" aria-expanded="true" aria-controls="plano<?php echo $idPlano;?>">
                        ...
                        <div class="px-2 me-0 ms-auto">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckDisabled">
                              <span class="valor-cotacao">Contratar On-Line</span>
                            </label>
                          </div>
                        </div>
                      </div>
                  ...
                  <div id="plano<?php echo $idPlano;?>" class="accordion-collapse collapse" data-bs-parent="#planoAc<?php echo $idPlano;?>">
                    <div class="accordion-body">
                      <div class="d-flex justify-content-center flex-column">
                            ...
                            <p class="text-center"> <span class="link_cotacao"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="personalizaModal('<?php echo $idPlano; ?>','<?php echo $regCotacao['plano'];?>')"> Hospitais que atendem</span> | Carências e Regras de aceitação</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <script src="../js/pages/cotacao2.js"></script>
